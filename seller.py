...
def seller_view_add_product():
    ...
    categories = []
    for i in products:
        if i['product_seller_id'] == user_session["session_id"] and i['product_category'] not in categories:
            categories.append(str(i['product_category']))
...
def seller_view_my_sales():
    ...
    for sale in sales:
        for product in products:
            if sale["sale_product_id"] == product['product_id'] and product['product_seller_id'] == user_session["session_id"]:
